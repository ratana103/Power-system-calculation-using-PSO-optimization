...
function result= nrloadflow(nbus,busd,linedata)
Y = ybusppg(linedata);          % Calling ybusppg.m to get Y-Bus Matrix..
...
result.del=del;
[result.Pi, result.Qi, result.Pg, result.Qg, result.Pl, result.Ql,...
             result.Lpij, result.Lqij, result.V,result.I] =loadflow(nbus,V,del,BMva,busd,linedata);  % Calling Loadflow.m..

power=[result.Pi result.Qi result.Pg result.Qg result.Pl result.Ql]'./BMva;
% result.Pi =result.Pi /BMva
% result.Qi=result.Qi/BMva
% result.Pg=result.Pg/BMva
% result.Qg=result.Qg/BMva
% result.Pl=result.Pl/BMva
% result.Ql=result.Ql/BMva